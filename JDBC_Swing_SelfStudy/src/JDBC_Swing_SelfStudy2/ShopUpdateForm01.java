...
public class ShopUpdateForm01 extends JFrame implements ActionListener{

	//Update는 Insert를 복사해서 변경해도 됨 - 유사한 구조
	//Delete & Update는 늘 단일 num값을 받아온다
	String num;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (ob==btnImage) {
			...
			//수정을 위해 num값을 넘겨받음 - updateShop으로 전달
			dto01.setNum(num);
			...
			//!!!!!!!!!!!!!!!!!!!!!!!!
			//이런 Form들은 단순히 dto에 값을 저장할 뿐
			//저장된 dto들을 이제 SE IN UP DE 에 넘길 것임
			//dbModel 객체의 update 메서드 호출
			dbModel01.updateShop(dto01);
